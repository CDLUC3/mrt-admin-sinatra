## Merritt Stack Presentations

- [Merritt Tagging and Build Rules](tagging/build.md)
- [ECS Deployment Process](deploy/build.md)
- [CloudWatch Metrics for File Retrievals](benchmark.md)
